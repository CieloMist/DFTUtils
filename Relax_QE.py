...
profile_settings = {'command': 'mpirun -n 96 pw.x -pd .true.', 'pseudo_dir': '/projects/b1027/Pseudopotentials/QE_Pseudos/'+ pseudo_type} # change for efficiency later if you need
