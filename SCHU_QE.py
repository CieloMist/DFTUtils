...
pseudo_type = qe_settings.pop('pseudo_type', 'efficiency')
...
profile_settings = {'command': 'mpirun -np 64 pw.x -pd .true.', 'pseudo_dir': '/projects/b1027/Pseudopotentials/QE_Pseudos/' + pseudo_type} # change for efficiency later if you need
